...
export const Timeline = ({ data, title, description }: { data: TimelineEntry[], title?: string, description?: string }) => {
  ...
  useEffect(() => {
    ...
    // Update height after a short delay to account for image loading
  ...
  const opacityTransform = useTransform(scrollYProgress, [0, 0.1], [0.5, 1]);
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-primary via-teal to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
