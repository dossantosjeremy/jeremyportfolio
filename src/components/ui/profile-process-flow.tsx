...
export const ProfileProcessFlow = ({ className }: { className?: string }) => {
  const width = 400;
  const height = 500;
  ...
  return (
    <div className={cn("relative w-full max-w-[500px] h-[450px] sm:h-[500px] mx-auto", className)}>
      ...
      >
        <div className="relative flex flex-col gap-2 p-4 rounded-2xl bg-zinc-900 border border-purple-500/50 shadow-[0_0_30px_rgba(168,85,247,0.3)]">
          <div className="absolute inset-0 rounded-2xl bg-purple-500/10 animate-pulse"></div>
          <div className="relative z-10 text-xs sm:text-sm font-bold text-white bg-zinc-800 px-4 py-2 rounded-lg border border-zinc-700 text-center shadow-md">
            UX Research
          </div>
          <div className="relative z-10 text-xs sm:text-sm font-bold text-white bg-zinc-800 px-4 py-2 rounded-lg border border-zinc-700 text-center shadow-md">
            Design
